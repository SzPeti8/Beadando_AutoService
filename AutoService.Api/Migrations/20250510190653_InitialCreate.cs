        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegPlate = table.Column<string>(type: "TEXT", nullable: false),
                    DateOfMake = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    WorkType = table.Column<int>(type: "INTEGER", nullable: false),
                    FaultDescription = table.Column<string>(type: "TEXT", nullable: false),
                    FaultSeverity = table.Column<int>(type: "INTEGER", nullable: false),
